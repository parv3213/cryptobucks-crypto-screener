...
const HighLowIndicator = ({ currentPrice, high, low }: { currentPrice: number; high: number; low: number }) => {
  ...
  return (
    <div className="mt-4 flex w-full items-center md:mt-8">
...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    <div className="fixed top-0 flex h-full w-full items-center justify-center bg-gray-200 bg-opacity-30 font-nunito backdrop-blur-sm">
      <div className="relative h-[75%] w-[90%] overflow-auto rounded-lg bg-gray-300 bg-opacity-75 text-white lg:h-[75%] lg:w-[65%]">
        {cryptoData ? (
          <div className="flex h-full flex-col justify-between p-6">
            <div>
              {/* Coin Name */}
              <div className="flex items-center justify-start">
                <img src={cryptoData?.image?.thumb} alt="crypto-icon" className="mx-2 w-[3rem]" />
              ...
              {/* Coin Details */}
              <div className="mt-4 flex h-full w-full flex-col md:mt-8 md:flex-row md:items-start md:justify-between">
                <div className="w-full md:w-[45%] ">
                  ...
                  {/* Market Cap and fdv */}
                  <div className="mt-4 flex flex-col justify-between md:mt-8 md:flex-row">
                    <div className="flex flex-col">
                    ...
                    <div className="mt-4 flex items-center justify-between md:mt-8">
                      <div className="flex flex-col">
                        ...
                        {cryptoData?.links?.homepage[0] ? (
                          <a
                            className="mb-2 rounded bg-gray-200 px-2 py-1 text-sm text-gray-100"
                ...
                <div className="ml-4 h-full w-full bg-white md:w-[55%]">Graph</div>
              </div>
            </div>
