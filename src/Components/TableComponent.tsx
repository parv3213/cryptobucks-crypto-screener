          ...
          {cryptoData.map(data => {
            return (
              <tr key={data.id} className="border-b border-gray-100 text-center text-base last:border-b-0 hover:bg-gray-200">
                ...
                <td className={`py-4 hover:bg-gray-200 ${data.market_cap_change_percentage_24h ? (data.market_cap_change_percentage_24h > 0 ? 'text-green' : 'text-red') : 'text-green'}`}>{`${Number(data.market_cap_change_percentage_24h).toFixed(2)}%`}</td>
                <td className={`py-4 hover:bg-gray-200 ${data.price_change_percentage_1h_in_currency ? (data.price_change_percentage_1h_in_currency > 0 ? 'text-green' : 'text-red') : 'text-green'}`}>{`${Number(data.price_change_percentage_1h_in_currency).toFixed(2)}%`}</td>
                <td className={`py-4 hover:bg-gray-200 ${data.price_change_percentage_24h ? (data.price_change_percentage_24h > 0 ? 'text-green' : 'text-red') : 'text-green'}`}>{`${Number(data.price_change_percentage_24h).toFixed(2)}%`}</td>
                <td className={`py-4 hover:bg-gray-200 ${data.price_change_percentage_7d_in_currency ? (data.price_change_percentage_7d_in_currency > 0 ? 'text-green' : 'text-red') : 'text-green'}`}>{`${Number(data.price_change_percentage_7d_in_currency).toFixed(2)}%`}</td>
              </tr>
            );
          })}
        </tbody>
