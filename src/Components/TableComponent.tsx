        ...
        <tbody>
          {cryptoData.map(data => {
            return (
              <tr
                key={data.id}
                className="border-b border-gray-100 text-center text-base last:border-b-0 hover:bg-gray-200"
              >
                <td className="flex items-center py-4 hover:bg-gray-200">
                  ...
                  <img src={data.image} alt="crypto image" className="mx-2 w-[1.25rem]" />
                ...
                <td className="py-4 hover:bg-gray-200">
                  {new Intl.NumberFormat('en-IN', {
                    ...
                    // TODO
                    currency: 'usd',
                  }).format(data.current_price.toFixed(2))}
                </td>
                <td className="py-4 hover:bg-gray-200">{data.total_volume.toFixed(2)}</td>
                <td
                  className={`py-4 hover:bg-gray-200 ${
                    data.market_cap_change_percentage_24h > 0 ? 'text-green' : 'text-red'
                  }`}
                >
                ...
                <td
                  className={`py-4 hover:bg-gray-200 ${
                    data.price_change_percentage_24h > 0 ? 'text-green' : 'text-red'
                  }`}
                >
